"""
Login screen with user authentication for the adventure game.
This script starts the game with a login screen, then launches the game after successful login.
"""
...
if __name__ == "__main__":
    print("Starting debug_game.py wrapper")
    main()
    print("Exiting debug_game.py wrapper")